...
type IEntityFind interface {
	...
	FindListByObjectIdList(idList []primitive.ObjectID, opts ...FindOption) IFindResult
...
func (r *MongoCol) FindListByObjectIdList(idList []primitive.ObjectID, opts ...FindOption) IFindResult {
